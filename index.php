<!doctype html>
  <html>
      ...
      <body>
          ...
          {{#users}}
              <li data-user-id="{{id}}"><span class="glyphicon glyphicon-user"></span> {{username}}</li>
          {{/users}}
          </script>
          ...
          {{#post}}
              <div class="post" data-post-id="{{id}}">
                  ...
                  <div class="post-actions">
                      <a class="glyphicon glyphicon-thumbs-up lnk-like-post" data-post-id="{{id}}" data-like="true">(0)</a>  
          ...
          {{#comment}}
              <div class="comment" data-comment-id="{{id}}">
                  ...
                  <div class="post-body">{{text}}</div>
                  <div class="post-actions">
                      <a class="glyphicon glyphicon-thumbs-up lnk-like-comment" data-comment-id="{{id}}" data-like="true">(0)</a>  
                  </div>
              </div>
          {{/comment}}
          </script>
